...
describe('QualityChip', () => {
  ...
  it('carries the numeric basis in the title so a hover explains the label', () => {
    ...
    expect(screen.getByTestId('quality-chip-suez')).toHaveAttribute('title', 'Recent observations · latest fix 4m ago · 6/6 hourly windows with data · 35 collection windows attempted');
  });
